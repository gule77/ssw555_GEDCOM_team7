...
public class US03and12Test extends TestCase{
    ...
    public void test11(){
        ...
        f1.setID("f011");
        i1.setId("I1101");
        i1.setBirthday("1919-01-12");
        i2.setId("I1102");
        i2.setBirthday("1939-01-12");
        individualMap.put("I1101", i1);
        individualMap.put("I1102", i2);
        f1.setHusbandId("I1101");
        f1.setWifeId("I1102");
        f1.setChildren(new ArrayList<>());
        f1.getChildren().add(HelperFuctions.individualWithIdAndBirthday(1111, 1999, 1, 11));
        Assert.assertFalse(US03and12.US12(f1, individualMap));
    }
}