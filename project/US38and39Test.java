...
public class US38and39Test extends TestCase {
	//test1
    ...
    protected void setUp() {
		...
		String married = "2019-12-01";
		String birthday1 = "2020-11-22";
		String birthday2 = "2020-12-01";
		I1.setAlive(true);
		I1.setId(id1);
		I1.setDeath("NA");
		I2.setAlive(true);
    ...
    public void test1() {
        assertTrue(US38and39.US38(individualList1));
      }
    public void test2() {
        assertTrue(US38and39.US39(familyList1,map1));
      }
}
